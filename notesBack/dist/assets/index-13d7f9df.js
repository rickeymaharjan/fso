  ...
  function x(C, R) {
    ...
    try {
      ...
      if (h !== null) var pr = !0;
        ...
        var xt = n(a);
        xt !== null && Bl(w, xt.startTime - R), (pr = !1);
      }
      return pr;
    } finally {
      (h = null), (y = O), (E = !1);
    ...
    (e.unstable_scheduleCallback = function (C, R, O) {
      ...
      return (
        ...
        O > Q
          ...
          : ((C.sortIndex = Z), t(s, C), m || E || ((m = !0), Ul(x))),
        C
      );
    }),
...
function zi(e, t, n, r) {
  if (Zr) {
    var l = Uo(e, t, n, r);
    if (l === null) ro(e, t, r, br, n), Du(e, r);
...
function Qd(e, t) {
  if (Vt)
    return e === "compositionend" || (!ji && Da(e, t))
      ? ((e = za()), (Ar = Fi = st = null), (Vt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
  ...
  va(function () {
    ...
    e: {
      ...
      if (y !== void 0) {
        ...
        0 < g.length &&
          ((y = new E(y, m, null, n, f)), h.push({ event: y, listeners: g }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (g = E, d = m, c = 0, p = g; p; p = Bt(p)) c++;
        ...
        e: {
          ...
          switch (((y = t), (E = n), g.tag)) {
            ...
            case 0:
              if (
                ((m = g.payload),
                (y = typeof m == "function" ? m.call(E, h, y) : m),
                y == null)
              )
                break e;
              h = H({}, h, y);
...
function ys(e, t, n, r, l) {
  ...
  if ((rn(t, l), t.stateNode === null))
    ...
    u !== h || y !== m || he.current || ot
      ? (typeof E == "function" && (qo(t, n, E, r), (m = t.memoizedState)),
        (a = ot || is(t, n, a, r, y, m, s) || !1)
          ? (f ||
...
function xp(e, t, n, r, l, o, i) {
  ...
  if (((u = (i & e.childLanes) !== 0), pe || u)) {
    ...
    return iu(), (r = co(Error(S(421)))), Tr(e, t, i, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function je(e, t, n, r) {
  if (50 < $n) throw (($n = 0), (ci = null), Error(S(185)));
  ur(e, n, r),
    (!(D & 2) || e !== ee) &&
...
function ml(e, t) {
  ...
  while (1);
  if ((Hi(), (D = n), (dl.current = r), X !== null)) throw Error(S(261));
...
function Ap(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    ee === e &&
      (ne & n) === n &&
      (q === 4 || (q === 3 && (ne & 130023424) === ne && 500 > K() - ru)
        ? Lt(e, 0)
        : (nu |= n)),
    ye(e, t);
}
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Oi(t, n | 1), ye(t, K()), !(D & 6) && ((dn = K() + 500), kt()));
      }
      break;
    case 13:
      Mt(function () {
...
const Jp = ({ note: e, toggleImportanceOf: t }) => {
    const n = e.important ? "Make not important" : "Make important";
    return J.jsx(J.Fragment, {
      children: J.jsxs("li", {
        className: "note",
        children: [e.content, J.jsx("button", { onClick: t, children: n })],
      }),
    });
  },
  Xp = ({ message: e }) =>
    e ? J.jsx("div", { className: "error", children: e }) : null;
function ef(e, t) {
  return function () {
...
const Nh = (e) => {
  ...
  Ph = We("AsyncFunction"),
  Th = (e) => e && (jl(e) || Pe(e)) && Pe(e.then) && Pe(e.catch),
  v = {
    isArray: vn,
    isArrayBuffer: tf,
    isBuffer: Gp,
...
function Ml(e, t, n) {
  ...
  function f(m, g, T) {
    ...
    return hi(m) ? !0 : (t.append(zs(T, g, o), a(m)), !1);
  }
  const h = [],
    y = Object.assign(Lh, {
      defaultVisitor: f,
...
const Ds = Fh,
  ...
  Dh = typeof URLSearchParams < "u" ? URLSearchParams : pu,
...
const gu = Y,
  ...
  pm = () => {
    ...
    const a = (m) => {
      ...
      f = l ? e : e.filter((m) => m.important === !0),
      h = (m) => {
        r(m.target.value);
      },
      y = (m) => {
        const g = e.find((d) => d.id === m),
          T = { ...g, important: !g.important };
        wo.update(m, T)
          .then((d) => t(e.map((c) => (c.id != m ? c : d))))
          .catch((d) => {
            const c = `the note '${g.content}' was already deleted from server`;
            u(c),
              setTimeout(() => {
                u(null);
              }, 5e3),
    ...
    return J.jsxs("div", {
      children: [
        ...
        J.jsx("ul", {
          children: f.map((m) =>
            J.jsx(Jp, { note: m, toggleImportanceOf: () => y(m.id) }, m.id)
          ),
        }),
        J.jsxs("form", {
          onSubmit: a,
          children: [
            J.jsx("input", { defaultValue: n, onChange: h }),
            J.jsx("button", { type: "submit", children: "save" }),
          ],
        }),
        J.jsx(E, {}),
      ],
...
So.createRoot(document.getElementById("root")).render(J.jsx(pm, {}));
